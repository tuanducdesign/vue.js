                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://thachpham.com/" target="_blank" rel="noreferrer" title="Thạch Phạm">
                                <img v-webp="/assets/images/thachpham.png" alt="Thạch Phạm" class="mmo-float img-thumbnail" loading="lazy" />
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://myclass.vn" target="_blank" rel="noreferrer" title="My Class">
                                <img v-webp="/assets/images/myclass.png" alt="My Class" class="mmo-float img-thumbnail" loading="lazy" />
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://zendvn.com" target="_blank" rel="noreferrer" title="Zend">
                                <img v-webp="/assets/images/zend.png" alt="Zend" class="mmo-float img-thumbnail" loading="lazy" />
