                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://thachpham.com/" target="_blank" rel="noreferrer" title="Thạch Phạm">
                                <img src="./assets/thachpham.png" alt="Thạch Phạm" class="mmo-float img-thumbnail" loading="lazy" />
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://myclass.vn" target="_blank" rel="noreferrer" title="My Class">
                                <img src="./assets/myclass.png" alt="My Class" class="mmo-float img-thumbnail" loading="lazy" />
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="https://zendvn.com" target="_blank" rel="noreferrer" title="Zend">
                                <img src="./assets/zend.png" alt="Zend" class="mmo-float img-thumbnail" loading="lazy" />
